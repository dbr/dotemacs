...
(let ((light-blue "#72A0CF")
  ...
  (custom-theme-set-faces
   ...
   `(gnus-cite-face-1 ((t (:foreground ,tomato))))
   `(gnus-cite-face-2 ((t (:foreground ,orange))))
   `(gnus-cite-face-3 ((t (:foreground ,violet))))
   `(gnus-cite-face-4 ((t (:foreground ,green))))
   `(gnus-cite-face-5 ((t (:foreground ,light-blue))))
   `(gnus-cite-face-6 ((t (:foreground ,yellow))))
   `(gnus-cite-face-7 ((t (:foreground ,blue))))
   `(gnus-header-name-face ((t (:bold t :foreground ,light-blue))))
   `(gnus-header-from ((t (:bold t :foreground ,yellow))))
   ...
   '(org-level-1 ((t (:bold t :foreground "#4788cc" :height 1.0))))
   ...
   '(org-todo ((t (:bold t :foreground "#ff2020" :background "grey10"))))
   '(org-done ((t (:bold t :foreground "grey50"))))
   '(org-checkbox-statistics-todo ((t (:inherit org-todo :background nil))))
   ...
   `(egocentric-face ((t (:foreground ,pink :weight bold))))
   ...
   '(flymake-errline ((t (:foreground "black" :background "#ff3333"))))
