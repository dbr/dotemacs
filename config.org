...
#+begin_src emacs-lisp
  (let ((local-conf-name (expand-file-name "current-host.el" dotfiles-dir))
        (perhost-conf-name (expand-file-name (format "%s.el" (first (split-string system-name "\\."))) dotfiles-dir)))
