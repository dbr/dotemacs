...
(custom-theme-set-faces
 ...
 '(magit-section-heading ((t (:foreground "#5180b3" :background nil))))
 '(magit-section-heading-selection ((t (:foreground "#68a5e9"))))
 '(magit-hash ((t (:foreground "#ab75c3" :background nil))))
 '(magit-branch-local ((t (:foreground "#dF9522" :background nil))))
 '(magit-branch-remote ((t (:foreground "#baba36" :background nil))))
 '(magit-diff-added-highlight ((t (:background "#303030" :foreground "#6aaf50"))))
 '(magit-diff-removed-highlight ((t (:background "#303030" :foreground "#cd5542"))))
 '(magit-diff-added ((t (:background nil :foreground "#6aaf50"))))
 '(magit-diff-removed ((t (:background nil :foreground "#cd5542"))))
 '(magit-diff-file-heading-selection ((t (:foreground "#68a5e9" :inherit magit-diff-file-heading-highlight))))
 '(magit-diff-hunk-heading-selection ((t (:foreground "#68a5e9" :inherit magit-diff-hunk-heading-highlight))))
 '(magit-diff-lines-heading ((t (:background "#528fd1" :foreground "gray13"))))
 '(magit-diffstat-added ((t (:background nil :foreground "#6aaf50"))))
 '(magit-diffstat-removed ((t (:background nil :foreground "#cd5542"))))
 '(magit-bisect-bad ((t (:foreground "#cd5542"))))
 '(magit-bisect-good ((t (:foreground "#6aaf50"))))
 '(magit-bisect-skip ((t (:foreground "#dF9522"))))
 '(magit-blame-date ((t (:foreground "#ab75c3" :background "grey25"))))
 '(magit-blame-hash ((t (:foreground "#ab75c3" :background "grey25"))))
 '(magit-blame-heading ((t (:foreground "#5180b3" :background "grey25"))))
 '(magit-blame-name ((t (:foreground "#6aaf50" :background "grey25"))))
 '(magit-blame-summary ((t (:foreground "#5180b3" :background "grey25"))))
 '(magit-process-ng ((t (:foreground "#cd5542" :bold t))))
 '(magit-process-ok ((t (:foreground "#6aaf50"))))
 '(magit-reflog-amend ((t (:foreground "#dF9522"))))
 '(magit-reflog-checkout ((t (:foreground "#5180b3"))))
 '(magit-reflog-cherry-pick ((t (:foreground "#6aaf50"))))
 '(magit-reflog-commit ((t (:foreground "#6aaf50"))))
 '(magit-reflog-merge ((t (:foreground "#6aaf50"))))
 '(magit-reflog-other ((t (:foreground "#528fd1"))))
 '(magit-reflog-rebase ((t (:foreground "#dF9522"))))
 '(magit-reflog-remote ((t (:foreground "#528fd1"))))
 '(magit-reflog-reset ((t (:foreground "#cd5542"))))
 '(magit-sequence-head ((t (:foreground "#528fd1"))))
 '(magit-sequence-part ((t (:foreground "#dF9522"))))
 '(magit-sequence-stop ((t (:foreground "#6aaf50"))))
 '(magit-signature-error ((t (:foreground "#cd5542"))))
 '(magit-signature-good ((t (:foreground "#6aaf50"))))
 '(magit-signature-revoked ((t (:foreground "#ab75c3"))))
 '(magit-signature-untrusted ((t (:foreground "#528fd1"))))
 '(magit-cherry-equivalent ((t (:foreground "#6aaf50" :background nil))))
 '(magit-cherry-unmatched ((t (:foreground "#528fd1" :background nil))))
 '(magit-log-author ((t (:foreground "#cd5542" :background nil))))
 '(magit-log-date ((t (:foreground "#5180b3" :background nil))))
